                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          'Genera una copia de la base de datos SQLite en la carpeta de descargas',
                  ...
                  child: provider.generatedReports.isEmpty
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final generatedTime = DateTime.parse(
                              rep['generatedAt'],
                            );
                                    ...
                                    if (await file.exists()) {
                                      if (isPdf) {
                                        ...
                                        ScaffoldMessenger.of(
                                          ...
                                          SnackBar(
                                            content: Text(
                                              'Archivo CSV guardado en: ${rep['filePath']}',
                                            ),
                                      ...
                                      ScaffoldMessenger.of(
                                        ...
                                        const SnackBar(
                                          content: Text(
                                            'El archivo temporal ya no existe, por favor regenéralo.',
                                          ),
                                        ),
                                      );
                                    }
